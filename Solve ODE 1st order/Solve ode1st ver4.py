""" This program solves differential equations of 1st order
    given in form y' = f(x, y).

    Define right side of equation f and region XLIM, YLIM by yourself.

    Default is y' = y**2 + x in region [-4, 4] x [-4, 4].

    Start the program and define initial conditions
    using mouse clicks and mouse moving:
    - click for freezing initial condition y(x_0)=y_0.

    Use right mouse move to chose new initial conditions.
...
def f(x, y):
    """ Right part of equation y' = f(x, y),
